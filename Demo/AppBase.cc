...
simtime_t AppBase::computeAsynchronousSendingTime(simtime_t interval, ChannelType chan)
{
...
void AppBase::handleLowerMsg(cMessage* msg)
{

    EV<<" Message is recieved from lower layer of kind"<<msg->getKind()<<endl;
    delete msg;
}

void AppBase::handleSelfMsg(cMessage* msg)
{
    EV<<"Self Message is recieved of kind"<<msg->getKind()<<endl;
    delete msg;
}
