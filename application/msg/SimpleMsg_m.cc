...
SimpleMsg::SimpleMsg(const char *name, short kind) : ::veins::BaseFrame1609_4(name,kind)
{
    this->certLTfrom = 0;
    this->certLTto = 0;
}

SimpleMsg::SimpleMsg(const SimpleMsg& other) : ::veins::BaseFrame1609_4(other)
{
    copy(other);
}
...
void SimpleMsg::copy(const SimpleMsg& other)
{
    ...
    this->certLTfrom = other.certLTfrom;
    this->certLTto = other.certLTto;
}
...
void SimpleMsg::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->certLTfrom);
    doParsimPacking(b,this->certLTto);
}
...
void SimpleMsg::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->certLTfrom);
    doParsimUnpacking(b,this->certLTto);
}
...
SimpleMsgDescriptor::SimpleMsgDescriptor() : omnetpp::cClassDescriptor("veins::SimpleMsg", "veins::BaseFrame1609_4")
{
